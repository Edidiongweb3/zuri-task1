...
function App() {
  return (
    <div className="body-area">
      ...
      <img src={slackimg} className='slack-img'></img>

      <img src={gitimg} className='github'></img> 
      </div>

        <div className='footer'>      
        <img src={zuriimg} className='image1' id='image1'></img>
        <p className='text'>HNG Intership 9 Frontend Task</p>
        <img src={hngicon} className='image' id='image'></img>
        </div>
